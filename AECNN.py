...
class AECNN(nn.Module):
    def __init__(self,config):
        ...
        self.encoder = AECNNEncoder(kernel_size = self.kernel_size, dropout_rate = self.dropout_rate)
        self.decoder = AECNNDecoder(kernel_size = self.kernel_size, dropout_rate = self.dropout_rate)
